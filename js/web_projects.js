                    ...
                    .then(data => {
                      ...
                      const tab = document.querySelector(".project-tab");
                        ...
                        d.addEventListener('click', () => {
                            ...
                            if (d.style.aspectRatio === "1" || d.style.aspectRatio === "1 / 1" || d.style.aspectRatio === "1/1") {
                              const boxes = wrapper.querySelectorAll(".box_inner");
                              const smallImgss = document.querySelectorAll(".column");

                              smallImgss.forEach(small => {
                                small.style.width = "10%";
                              })
                            } else {
                              imege.style.width = "100%";
                            }
